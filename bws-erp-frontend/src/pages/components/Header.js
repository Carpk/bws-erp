    ...
    <div className="container header">
      <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="#" className="nav-link px-2 text-black">Work</a></li>
          <li><a href="#" className="nav-link px-2 text-black">Process</a></li>
          <li><a href="#" className="nav-link px-2 text-black">Philosophy</a></li>
          <li><a href="#" className="nav-link px-2 text-black">Company</a></li>
        </ul>
